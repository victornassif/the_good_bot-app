...
class ChatTestView extends StatefulWidget {
  ChatTestView({Key key, this.title}) : super(key: key);
...
class _ChatView extends State<ChatTestView> {
  ...
  getData() async {
    ...
    var a = collectionSnapshot.documents;
